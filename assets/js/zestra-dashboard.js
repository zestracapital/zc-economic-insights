...
(function() {
    ...
    class ZestraDashboard {
        ...
        async fetchIndicatorData(slug) {
            ...
            if (!json || !json.success || !json.data || !Array.isArray(json.data.series) || json.data.series.length === 0) {
        ...
        async addComparison(slug, name) {
            ...
            try {
                ...
                if (data.success && data.data.series && data.data.series.length > 0) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Find containers with zestra dashboard class
