...
if (!class_exists('ZC_DMT_Enhanced_Shortcodes')) {
    ...
    class ZC_DMT_Enhanced_Shortcodes {
         ...
         * Usage: [zc_economic_dashboard mode="dynamic" height="800" show_search="true"]
         */
         ...
         * Usage: [zc_chart_enhanced id="gdp_us" type="line" show_stats="true"]
         */
         ...
         * Usage: [zc_chart_comparison indicators="gdp_us,unemployment_rate" height="600"]
         */
        ...
        private static function enqueue_dashboard_assets() {
            ...
            if (!wp_script_is('zc-zestra-dashboard', 'enqueued')) {
                ...
                wp_localize_script('zc-zestra-dashboard', 'zcDmtConfig', array(
        ...
        /**
         * Get available indicators for JavaScript
         */
        private static function get_available_indicators() {
            $indicators = ZC_DMT_Indicators::list_indicators(100);
            $formatted = array();
         ...
         * Usage: [zc_chart_calculation id="gdp_growth_rate" chart_type="line" height="600"]
         */
