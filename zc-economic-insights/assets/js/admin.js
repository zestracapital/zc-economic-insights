...
(function($){
  $(function(){
    ...
    var $quandlRow = $('#zc_quandl_row');
    var $bocRow = $('#zc_boc_row');
    var $statcanRow = $('#zc_statcan_row');
    var $rbaRow = $('#zc_rba_row');
    var $ecbRow = $('#zc_ecb_row');
    var $uniCsvRow = $('#zc_universal_csv_row');
    var $uniJsonRow = $('#zc_universal_json_row');
    ...
    function toggleSourceRow(){
      ...
      if ($quandlRow.length) {
        $quandlRow.toggle(val === 'quandl');
      }
      if ($bocRow.length) {
        $bocRow.toggle(val === 'bank_of_canada');
      }
      if ($statcanRow.length) {
        $statcanRow.toggle(val === 'statcan');
      }
      if ($rbaRow.length) {
        $rbaRow.toggle(val === 'australia_rba');
      }
      if ($ecbRow.length) {
        $ecbRow.toggle(val === 'ecb');
      }
      if ($uniCsvRow.length) {
        $uniCsvRow.toggle(val === 'universal_csv');
      }
      if ($uniJsonRow.length) {
        $uniJsonRow.toggle(val === 'universal_json');
      }
    }
