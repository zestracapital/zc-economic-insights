    ...
    if (!empty($_POST['zc_dmt_action'])) {
        if (!isset($_POST['zc_dmt_nonce']) || !wp_verify_nonce(sanitize_text_field($_POST['zc_dmt_nonce']), 'zc_dmt_settings_action')) {
            ...
            if ($action === 'generate_key') {
                ...
                $default_api_key = isset($_POST['zc_charts_default_api_key']) ? sanitize_text_field($_POST['zc_charts_default_api_key']) : '';
                ...
                update_option('zc_dmt_default_api_key', $default_api_key);
            ...
            <form method="post">
                ...
                <table class="form-table" role="presentation">
                    <tbody>
                        ...
                        <tr>
                            <th scope="row"><label for="zc_charts_default_api_key"><?php echo esc_html__('Default API Key', 'zc-dmt'); ?></label></th>
                            <td>
                                <input type="text" name="zc_charts_default_api_key" id="zc_charts_default_api_key" class="regular-text" value="<?php echo esc_attr($default_api_key); ?>" placeholder="<?php echo esc_attr__('Enter a default API key', 'zc-dmt'); ?>" />
                                <p class="description">
                                    <?php echo esc_html__('This API key will be used by default if none is provided in the shortcode. Leave blank to require an API key in each shortcode.', 'zc-dmt'); ?>
                                </p>
                            </td>
                        </tr>
                        <tr>
